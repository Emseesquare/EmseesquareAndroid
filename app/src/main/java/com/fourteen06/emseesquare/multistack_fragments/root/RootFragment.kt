package com.fourteen06.emseesquare.multistack_fragments.root
...
import com.fourteen06.emseesquare.databinding.RootFragmentBinding
...
class RootFragment : Fragment(R.layout.root_fragment) {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (savedInstanceState == null) {
            val firstFragment =
                FragmentStackHostFragment.newInstance(R.navigation.navigation_root_first)
                    .also { this.firstFragment = it }
            val secondFragment =
                FragmentStackHostFragment.newInstance(R.navigation.navigation_root_second)
                    .also { this.secondFragment = it }
            val thirdFragment =
                FragmentStackHostFragment.newInstance(R.navigation.navigation_root_third)
